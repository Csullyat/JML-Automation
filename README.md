...
- **`microsoft_termination.py`** - Microsoft 365/Exchange mailbox conversion and license removal
...
3. **Phase 3: Microsoft 365 Termination**
   - Convert mailbox to shared mailbox (if both user and manager found)
   - Grant manager access to shared mailbox
   - Remove user licenses (frees licenses for other users)
   - **Keep user account in unlicensed state (Okta manages access control)**
