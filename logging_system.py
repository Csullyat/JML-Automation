# logging_system.py - Centralized logging configuration for termination automation
...
def setup_logging(log_level: str = "INFO", 
    ...
    """
    Set up comprehensive logging for the termination automation system.
    ...
    if log_to_file:
        ...
        main_log_file = log_path / "termination_automation.log"
        ...
        error_log_file = log_path / "termination_errors.log"
        ...
        daily_log_file = log_path / f"termination_{today}.log"
    ...
    # Log startup message
    logger.info("=" * 80)
    logger.info("TERMINATION AUTOMATION LOGGING INITIALIZED")
...
def log_termination_action(user_email: str, action: str, result: str, 
    ...
    Args:
        user_email: Email of the user being terminated
        action: Action being performed (e.g., "DEACTIVATE", "REMOVE_FROM_GROUP")
    ...
    message = f"TERMINATION_ACTION | {user_email} | {action} | {result}"
    if ticket_number:
...
def log_performance_metric(operation: str, duration_seconds: float, 
    ...
    Args:
        operation: Operation name (e.g., "FULL_TERMINATION_RUN", "TICKET_FETCH")
        ...
        with open(log_file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                if 'TERMINATION_ACTION' in line:
                    ...
                    if '| SUCCESS' in line:
                        summary['successful_terminations'] += 1
                    elif '| FAILED' in line:
