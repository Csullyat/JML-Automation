...
def run_microsoft_termination_test():
    ...
    if not filtered:
        ...
        return
    # Test Microsoft termination for each ticket
    ...
    for i, ticket in enumerate(filtered):
        ...
        if user_email and manager_email:
            ...
            result = ms_term.execute_complete_termination(user_email, manager_email)
...
if __name__ == "__main__":
    run_microsoft_termination_test()
